      ...
      <div className='container '>
        <div className='row'>
          ...
          <div className='col-md-6 col-lg-4 col-12 ft-3'>
            <h5>Quick Links</h5>
            <p> <FontAwesomeIcon icon="phone" className='icon1'/> 987543210</p>
            <p> <FontAwesomeIcon icon="envelope" className='icon1' />abc@gmail.com</p>
            <p> <FontAwesomeIcon icon="paper-plane" className='icon1'/>Navi Mumbai</p>
          </div>
        </div>
      </div>
    </div>
